declare var hcaptcha: ReCaptchaV2.ReCaptcha;

interface ClientMessage {
    type: "Upload";
}

interface Upload extends ClientMessage {
    type: "Upload";
    api_key: string;
...
interface Current extends ServerMessage {
    type: "Current";
    transferred: number;
}

interface Error extends ServerMessage {
    type: "Error";
    description: string;
}

interface Finished extends ServerMessage {
    type: "Finished";
    url: string;
}

interface InQueue extends ServerMessage {
    type: "InQueue";
    position: number;
}
...
interface StartedTransfer extends ServerMessage {
